...
export interface ComptrollerG7Interface extends utils.Interface {
  ...
  functions: {
    ...
    "getBorrowerLimits(address)": FunctionFragment;
    ...
    "setBorrowerLimits(address,uint256)": FunctionFragment;
    ...
    "whitelistBorrowerAdd(address)": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "getBorrowerLimits",
    values: [string]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setBorrowerLimits",
    values: [string, BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "whitelistBorrowerAdd",
    values: [string]
  ): string;
  ...
  events: {
    ...
    "BorrowerLimitChanged(address,uint256)": EventFragment;
    "BorrowerWhitelisted(address)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "BorrowerLimitChanged"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "BorrowerWhitelisted"): EventFragment;
...
export type BorrowerLimitChangedEvent = TypedEvent<
  [string, BigNumber],
  { borrower: string; borrowLimit: BigNumber }
>;

export type BorrowerLimitChangedEventFilter =
  TypedEventFilter<BorrowerLimitChangedEvent>;

export type BorrowerWhitelistedEvent = TypedEvent<
  [string],
  { borrower: string }
>;

export type BorrowerWhitelistedEventFilter =
  TypedEventFilter<BorrowerWhitelistedEvent>;
...
export interface ComptrollerG7 extends BaseContract {
  ...
  filters: {
    ...
    "BorrowerLimitChanged(address,uint256)"(
      borrower?: null,
      borrowLimit?: null
    ): BorrowerLimitChangedEventFilter;
    BorrowerLimitChanged(
      borrower?: null,
      borrowLimit?: null
    ): BorrowerLimitChangedEventFilter;
    ...
    "BorrowerWhitelisted(address)"(
      borrower?: null
    ): BorrowerWhitelistedEventFilter;
    BorrowerWhitelisted(borrower?: null): BorrowerWhitelistedEventFilter;
